...
## Planning Meetings (SR(N-1).md, sprintN.md) (max 2 marks)
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1  
    Feedback: Spikes not identified and missing team capacity. Please also include your task breakdown on the documentation as well other than on Jira.    
...
## Daily Stand-ups (max 10 marks)
  ...
  Feedback: Great job on your standups!
...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    Your Mark: 1
    Feedback: Please ensure that the user stories follow the template format (As a ____, I want to _____, so that ______)
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 0
    Feedback: No acceptance criteria found for the user stories 
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Did you start all stories for sprint two? (max 2 marks)
    ...
    Your Mark: 1
    Feedback: JUIC-31 started but not completed with no explanation provided 
...
## Sprint Completion (Max 20 marks) 
  ...
  Your Mark: 15 / 20
  Feedback: JUIC-31 started but not completed. 
